  ...
  export default {
    ...
    data() {
      return {
        ...
        dpyhq:1,
        closeShow:false,
        liArr:[{name:"人气",sortType:0,queryType:2,index:0},{name:"默认",sortType:0,queryType:0,index:1},{name:"销量",sortType:9,queryType:0,index:2},{name:"价格",sortType:3,queryType:0,index:3}],
        couponItems:[],
        toPage:1,
        perPageSize:20,
        queryType:2,
